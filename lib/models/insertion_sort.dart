...
class InsertionSort implements SortingAlgorithm {
  ...
  Stream<SortingState> sort(List<int> initialArray) async* {
    ...
    for (int i = 1; i < n; i++) {
        ...
        yield SortingState(List.from(array), [i], StepType.compare, message: "Selected key: $key");
        ...
        array[j + 1] = key;
        // Show placement
        yield SortingState(List.from(array), [j + 1], StepType.overwrite, message: "Placed $key");
    }
